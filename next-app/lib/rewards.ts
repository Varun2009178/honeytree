...
export const REWARD_THRESHOLDS = [
  ...
  { slug: "pine", label: "Pine", description: "Evergreen pines join your forest", threshold: 2 },
  { slug: "oak", label: "Oak", description: "Broad oaks join your forest", threshold: 4 },
  { slug: "ancient", label: "Ancient", description: "Rare tall golden ancients join your forest", threshold: 7 },
  { slug: "mythic", label: "Mythic", description: "Glowing mythic trees join your forest", threshold: 10 },
] as const
